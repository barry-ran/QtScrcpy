...
struct qt_meta_stringdata_VideoForm_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VideoForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VideoForm_t qt_meta_stringdata_VideoForm = {
    {
QT_MOC_LITERAL(0, 0, 9) // "VideoForm"
...
static const uint qt_meta_data_VideoForm[] = {
...
QT_INIT_METAOBJECT const QMetaObject VideoForm::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_VideoForm.data,
    qt_meta_data_VideoForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VideoForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoForm.stringdata0))
